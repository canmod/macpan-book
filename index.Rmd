...
This generalized McMasterPandemic framework is still in an experimental phase. Therefore you will need to install the experimental `tmb-condense` branch that contains the experimental implementation directly from github. A convenient way to do this is using the `remotes` package as follows.
